...
<body class="">
  ...
  <div class="wrapper">
    ...
    @endforeach
    <!-- Cart button -->
    <button data-toggle="modal" data-target="#cart" style="position: absolute; bottom: 10px; right: 10px; padding: 10px; border-radius: 20px; font-size: 20px" class="btn btn-warning"><i style="font-size: 40px" class="fas fa-shopping-cart"></i> ({{$count}})</button>
